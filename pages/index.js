...
const data = [
  ...
  },
  {
    ...
    content: "It’s all about having fun when Mars enters Taurus on Monday and moves through your pleasure zone for the next six weeks. Actually use your vacation days to chill and unwind, Capricorn. ",
    from: "December 22",
    to: "January 19",
  },
  {
      ...
      <main>
        ...
        <div>
          <ul className={styles.list}>
            {data.map((horoscope) => (
              <li key={horoscope.name} className={styles["flip-card"]}>
